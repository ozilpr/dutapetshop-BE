...
const AdminPayloadSchema = Joi.object({
  ...
  password: Joi.string()
    ...
    .messages({
      'string.pattern.base':
        '"Password" dengan nilai "{#value}" tidak sesuai pola yang diperlukan: hanya huruf dan angka, 3-30 karakter.',
  ...
  confPassword: Joi.string()
    ...
    .messages({
      'string.pattern.base':
        '"Konfirmasi Password" dengan nilai "{#value}" tidak sesuai pola yang diperlukan: hanya huruf dan angka, 3-30 karakter.',
